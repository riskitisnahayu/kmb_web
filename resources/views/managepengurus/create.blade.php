...
<div class="container">
	<div class="row">
		...
		<h3 style="text-align: center;"><b>Pengurus Baru<b></h3><br><br>
		@if (count($errors) > 0)
		...
		@endif
		{!! Form::open(array('route' => 'pengurus.store','method'=>'POST')) !!}
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-12 text-center" style="margin-bottom: 10px">
				<button type="button" class="btn btn-danger" onclick="location.href='{{url('/admin/pengurus')}}'">Batal</button>
